...
const DesignProcess: React.FC<DesignProcessProps> = ({ title, steps }) => {
  return (
    <SectionWithContainer containerClassName="md:space-y-14 space-y-10 " sectionClassName="bg-secondary">
...
export const StepsCards: React.FC<DesignProcessProps["steps"][0]> = ({
  ...
  return (
    <div className="flex flex-col space-y-4 bg-white border border-dark p-6 box-shadow w-90">
